...
describe('Trade', () => {
  ...
  const token2 = new Token(ChainId.BaseMainnet, '0x0000000000000000000000000000000000000003', 18, 't2')
  const token3 = new Token(ChainId.BaseMainnet, '0x0000000000000000000000000000000000000004', 18, 't3')
  ...
  const pair_weth_0 = new Pair(
    new TokenAmount(CELO[ChainId.BaseMainnet], JSBI.BigInt(1000)),
  ...
  describe('#bestTradeExactIn', () => {
    ...
    it('works for CELO_CURRENCY currency input', () => {
      ...
      expect(result[0].route.path).toEqual([CELO[ChainId.BaseMainnet], token0, token1, token3])
      expect(result[0].outputAmount.currency).toEqual(token3)
      expect(result[1].inputAmount.currency).toEqual(CELO_CURRENCY)
      expect(result[1].route.path).toEqual([CELO[ChainId.BaseMainnet], token0, token3])
    ...
    it('works for CELO_CURRENCY currency output', () => {
      ...
      expect(result[0].route.path).toEqual([token3, token0, CELO[ChainId.BaseMainnet]])
      expect(result[0].outputAmount.currency).toEqual(CELO_CURRENCY)
      expect(result[1].inputAmount.currency).toEqual(token3)
      expect(result[1].route.path).toEqual([token3, token1, token0, CELO[ChainId.BaseMainnet]])
