...
import { ChainId as UbeswapChainId, USDT, JSBI, Token, TokenAmount } from '@ubeswap/sdk'
...
export const useLPValue = (
  ...
  const cusd = USDT[chainId as unknown as UbeswapChainId]
            ...
            stakedAmount
              ? JSBI.divide(
                  JSBI.multiply(
                    ...
                    // this is b/c the value of LP shares are ~double the value of the USDT they entitle owner to
                    JSBI.BigInt(2)
                  ),
