import { CELO, ChainId, USDT, JSBI, Percent, Token } from '@ubeswap/sdk'
...
export const LIMIT_ORDER_ADDRESS = {
  [ChainId.BaseMainnet]: '0x83013dCE53676F523dB8175832f2f3AD5B1fBb1f',
  [ChainId.BaseGoerli]: '0xb5911e904EEf100803D5d4bDb22ff1177324e7F3'
}

export const ORDER_BOOK_ADDRESS = {
  [ChainId.BaseMainnet]: '0x55e0E091a5a6f178B1b225E7369E8C91d4F64992',
  [ChainId.BaseGoerli]: '0x12553790998fa8d3CCCC2906192267576130DD3f'
}

export const ORDER_BOOK_REWARD_DISTRIBUTOR_ADDRESS = {
  [ChainId.BaseMainnet]: '0x3c57D786BdC33D30de25fE3f8b3fD3Fd3ff503e3',
  [ChainId.BaseGoerli]: '0x39F2854fC1786Bb0d0883FAf0F2a1c2fb458bCA8'
}

export const MULTICALL_ADDRESS = {
  [ChainId.BaseMainnet]: '0x75f59534dd892c1f8a7b172d639fa854d529ada3',
  [ChainId.BaseGoerli]: '0x387ce7960b5DA5381De08Ea4967b13a7c8cAB3f6'
}

export const POOF = {
  [ChainId.BaseMainnet]: new Token(ChainId.BaseMainnet, '0x00400FcbF0816bebB94654259de7273f4A05c762', 18, 'POOF', 'POOF'),
  [ChainId.BaseGoerli]: new Token(ChainId.BaseGoerli, '0x00400FcbF0816bebB94654259de7273f4A05c762', 18, 'POOF', 'POOF'),
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.BaseMainnet]: [USDT, CELO, CEUR, UBE, MCUSD, MCEUR, MCELO, POOF].map((el) => el[ChainId.BaseMainnet]),
  [ChainId.BaseGoerli]: [USDT, CELO, CEUR].map((el) => el[ChainId.BaseGoerli])
}

// used for display in the default list when adding liquidity
export const SUGGESTED_BASES: ChainTokenList = {
  ...BASES_TO_CHECK_TRADES_AGAINST,
  [ChainId.BaseMainnet]: [MCUSD, MCEUR, CELO].map((el) => el[ChainId.BaseMainnet]),
  [ChainId.BaseGoerli]: [MCUSD, MCEUR, CELO].map((el) => el[ChainId.BaseGoerli]),
}
...
export const PINNED_PAIRS: { [chainId: number]: [Token, Token][] } = {
  [ChainId.BaseMainnet]: [
    ...
    [MCUSD, UBE],
    [MCEUR, UBE],
  ].map((el) => el.map((t) => t[ChainId.BaseMainnet]) as [Token, Token]),
  [ChainId.BaseGoerli]: [
    [USDT, CELO],
    [MCUSD, CELO],
  ].map((el) => el.map((t) => t[ChainId.BaseGoerli]) as [Token, Token])
}
...
export const ubeGovernanceAddresses = {
  [ChainId.BaseMainnet]: '0xa7581d8E26007f4D2374507736327f5b46Dd6bA8',
  [ChainId.BaseGoerli]: '0xa7581d8E26007f4D2374507736327f5b46Dd6bA8'
}
