...
import { ContractKitProvider, BaseMainnet, BaseTestnet } from '@celo-tools/use-contractkit'
...
const GOOGLE_ANALYTICS_IDS = {
  production: {
    [ChainId.BaseMainnet]: 'UA-189817928-4',
    [ChainId.BaseGoerli]: 'UA-189817928-5'
  },
  staging: {
    [ChainId.BaseMainnet]: 'UA-189817928-2',
    [ChainId.BaseGoerli]: 'UA-189817928-3'
  },
}
...
ReactDOM.render(
  <StrictMode>
    ...
    <ContractKitProvider
      ...
      network={BaseTestnet}
      networks={[BaseMainnet, BaseTestnet]}
      connectModal={{
        reactModalProps: {
          style: {
            content: {
