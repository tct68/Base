...
import { CELO, ChainId as UbeswapChainId, USDT, Fraction, TokenAmount, TradeType } from '@ubeswap/sdk'
...
export const MoolaDirectTradeDetails: React.FC<Props> = ({ trade }: Props) => {
  ...
  const [, pair] = usePair(celo, USDT[chainId as unknown as UbeswapChainId])
  const cusdPrice = pair?.priceOf(USDT[chainId as unknown as UbeswapChainId])
