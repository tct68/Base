    ...
    <>
      ...
      {/* <RowBetween>
        <RowFixed>
          ...
          <QuestionHelper text="Many Ubeswap pools use mCUSD or mCEUR as collateral. Ubeswap allows you to easily swap USDT or cEUR for mcUSD without having to worry about manually depositing or withdrawing tokens." />
        </RowFixed>
      </RowBetween> */}
    </>
  )
