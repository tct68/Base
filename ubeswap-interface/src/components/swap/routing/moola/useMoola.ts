...
import { CELO, ChainId, cREAL, currencyEquals, USDT, Token } from '@ubeswap/sdk'
...
export const moolaLendingPools = {
  ...
  [ChainId.BaseGoerli]: {
    ...
    [CeloContract.GoldToken]: CELO[ChainId.BaseGoerli],
    [CeloContract.StableToken]: USDT[ChainId.BaseGoerli],
    mcUSD: MCUSD[ChainId.BaseGoerli],
    mCREAL: MCREAL[ChainId.BaseGoerli],
    mCELO: MCELO[ChainId.BaseGoerli],
  },
  [ChainId.BaseMainnet]: {
    ...
    [CeloContract.GoldToken]: CELO[ChainId.BaseMainnet],
    [CeloContract.StableToken]: USDT[ChainId.BaseMainnet],
    mcUSD: MCUSD[ChainId.BaseMainnet],
    mCREAL: MCREAL[ChainId.BaseMainnet],
    mCELO: MCELO[ChainId.BaseMainnet],
  },
}
